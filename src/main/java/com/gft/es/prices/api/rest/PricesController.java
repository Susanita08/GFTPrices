package com.gft.es.prices.api.rest;
...
import static com.gft.es.prices.utils.ConstantsUtils.*;
...
public class PricesController {
    ...
    @Autowired
    private final IAdapterPriceService adapterPriceService;

    public PricesController(IAdapterPriceService adapterPriceService) {
    ...
    public ResponseEntity<String> getHealth() {
        ...
        return ResponseEntity.status(getHttpStatusFromResponseCode(ApplicationMessage.SUCCESS.getStrCode())).body("Api is alive in path prices/api/v1/.....");
    }
